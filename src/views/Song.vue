...
export default {
  ...
  data() {
    return {
      ...
      commnet_alert_message: 'Please wait! Your comment is being submitted',
      comments: [],
      sort: '1',
    };
  },
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      this.commnet_alert_message = 'Please wait! Your comment is being submitted';
      ...
      this.commnet_alert_message = 'Comment added!';
